...
M.setup = function()
    ...
    utils.highlight('Comment', { fg = colours.dim_green, italic = true })
    ...
    utils.highlight('Identifier', { fg = colours.white })
    ...
    utils.highlight('Operator', { fg = colours.dim_cyan, bold = true })
    ...
    utils.highlight('Include', { fg = colours.cyan })
    ...
    utils.highlight('Type', { fg = colours.green })
    utils.highlight('StorageClass', { fg = colours.green })
    utils.highlight('Structure', { fg = colours.green })
    utils.highlight('Typedef', { fg = colours.green })
    ...
    utils.highlight('IncSearch', { fg = colours.black, bg = colours.green })
    ...
    utils.highlight('Normal', { fg = colours.white, bg = colours.black })
    ...
    utils.highlight('markdownIdDelimiter', { fg = colours.magenta })
    utils.highlight('markdownId', { fg = colours.magenta })
    ...
    utils.highlight('markdownUrl', { fg = colours.magenta })
    ...
    utils.highlight('Headlinemagenta', { bg = colours.diff_magenta })
    ...
    utils.highlight('OrgTSHeadlineLevel4', { fg = colours.magenta, bold = true })
    ...
    utils.highlight('TSConstBuiltin', { fg = colours.dark_yellow, bold = true, italic = true })
    ...
    -- functions
    utils.highlight('TSFuncBuiltin', { fg = colours.dark_yellow, bold = true, italic = true })
    -- utils.highlight('TSFunction', {})
    utils.highlight('TSFuncMacro', { fg = colours.dim_magenta, bold = true })
    ...
    utils.highlight('TSConstructor', { fg = colours.green })
    ...
    utils.highlight('TSTypeBuiltin', { fg = colours.dark_yellow, bold = true, italic = true })
    -- utils.highlight('TSStructure', {})
    -- utils.highlight('TSInclude', {})

    -- -- variable
    -- utils.highlight('TSVariable', {})
    utils.highlight('TSVariableBuiltin', { fg = colours.dark_yellow, bold = true, italic = true })
    ...
    utils.highlight('TSTagAttribute', { fg = colours.dim_red })
    -- utils.highlight('TSTagDelimiter', {})

    -- diagnostics
    utils.highlight('DiagnosticError', { fg = colours.dark_red, bold = true })
    utils.highlight('DiagnosticWarn', { fg = colours.yellow, bold = true })
    ...
    utils.highlight('DiagnosticUnderlineWarning', { sp = colours.yellow, undercurl = true })
    ...
    utils.highlight('CmpItemAbbrDeprecated', { fg = colours.white, italic = true, strikethrough = true })
    utils.highlight('CmpItemAbbrMatch', { fg = colours.dim_magenta })
    utils.highlight('CmpItemAbbrMatchFuzzy', { fg = colours.dim_magenta })
    utils.highlight('CmpItemMenu', { fg = colours.dark_yellow, italic = true })
    ...
    utils.highlight('CmpItemKindConstant', { fg = colours.magenta })
    ...
    utils.highlight('CmpItemKindClass', { fg = colours.green })
    utils.highlight('CmpItemKindInterface', { fg = colours.dim_green })
    utils.highlight('CmpItemKindStruct', { fg = colours.green })
    utils.highlight('CmpItemKindModule', { fg = colours.blue })
    ...
    utils.highlight('NotifyTRACEBorder', { fg = colours.magenta })
    ...
    utils.highlight('NotifyTRACEIcon', { fg = colours.magenta })
    ...
    utils.highlight('NotifyTRACETitle', { fg = colours.magenta })
    ...
    -- c/c++
    utils.highlight('cppTSConstructor', { fg = colours.dim_blue, bold = true })
    -- css
    utils.highlight('cssTSString', { fg = colours.yellow })
    utils.highlight('scssTSString', { fg = colours.yellow })
    --html
    utils.highlight('htmlTSString', { fg = colours.yellow })
    -- json
    utils.highlight('jsonTSString', { fg = colours.yellow, italic = true })
    utils.highlight('jsonTSNumber', { fg = colours.cyan, bold = true })
    -- rust
    utils.highlight('rustTSPunctSpecial', { fg = colours.magenta, bold = true })
    -- toml
    utils.highlight('tomlTSProperty', { fg = colours.dim_blue })
    utils.highlight('tomlTSString', { fg = colours.dim_yellow })
    --typescript
    utils.highlight('typescriptTSFunction', { fg = colours.dark_yellow, italic = true })
end
