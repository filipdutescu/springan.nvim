...
M.setup = function()
    ...
    utils.highlight('DiffAdd', { bg = colours.diff_green })
    utils.highlight('DiffChange', { bg = colours.diff_yellow })
    utils.highlight('DiffDelete', { fg = colours.dim_black })
    utils.highlight('DiffDeleteOld', { bg = colours.diff_red })
    utils.highlight('DiffText', { bg = colours.diff_yellow })
    ...
    utils.highlight('markdownCodeDelimiter', { fg = colours.cursor_grey })
    ...
    utils.highlight('CodeBlock', { bg = colours.dimm_black })
    utils.highlight('HeadlineGreen', { bg = colours.diff_green })
    utils.highlight('HeadlineBlue', { bg = colours.dimm_cursor_gret })
